...
with open(os.path.dirname(__file__)+'/../b_w_lists/tlf.json') as file:
    tlf_bw = json.load(file)
regex_string = r"((\b|(\B\+45 ?))(([2-9][0-9] ?)([1-9][0-9] ?)([0-9]{2} ?[0-9]{2})))\b"
tag_name = "TELEFONNUMMER"
category_guid = "50a52eee-d0d0-4f34-8d97-d3c696a52882"


whitelist_words = set(tlf_bw["whitelist"])
blacklist_words = set(tlf_bw["blacklist"])
words_count = 4
