...
with open(os.path.dirname(__file__)+'/../b_w_lists/matrikel.json') as file:
    mat_bw = json.load(file)
regex_string = r"\b(\d{1,4}[a-zA-ZæøåÆØÅ]{0,3})\b"
tag_name = "MATRIKELNUMMER"
category_guid = "84025962-72d2-4739-97fd-0cb7d7b12347"

whitelist_words = set(mat_bw["whitelist"])
blacklist_words = set(mat_bw["blacklist"])
words_count = 4
