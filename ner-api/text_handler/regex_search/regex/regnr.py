...
with open(os.path.dirname(__file__)+'/../b_w_lists/regnr.json') as file:
    regnr_bw = json.load(file)
regex_string = r"\b(\d{4})\b"
tag_name = "REGNR"
category_guid = "fb9bc47a-37bd-4b0e-85bd-cfd26ad20c6c"

whitelist_words = set(regnr_bw["whitelist"])
blacklist_words = set(regnr_bw["blacklist"])
words_count = 4
