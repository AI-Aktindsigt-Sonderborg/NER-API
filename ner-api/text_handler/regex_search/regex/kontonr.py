...
regex_string = r"\b([\da-zA-Z]{10})\b"
tag_name = "KONTONR"
category_guid = "b60fb96a-5765-4228-a643-aade8894b22e"
with open(os.path.dirname(__file__)+'/../b_w_lists/kontonr.json') as file:
    kontonr_bw = json.load(file)

whitelist_words = set(kontonr_bw["whitelist"])
blacklist_words = set(kontonr_bw["blacklist"])
words_count = 4
